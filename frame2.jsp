...
<%
   ...
   if (clientID1 == null) {
      ...
      script.println("location.href = 'login.jsp?pageNum=frame2';");
      script.println("</script>");
   } else {
%>
...
<body class="skin-blue-light sidebar-collapse">
   ...
   <div class="content-wrapper">
      ...
      <!-- <div id="mainDiv" style="display:block; position:absolute; top:0px; left:0px; width:100%; height:100%;">
         <iframe src="home.jsp" width="100%" height="100%" srcrolling="no"
         frameborder="0" border="0" bordercolor="#000000" marginwidth="0"
         marginheight="0" framespacing="0" vspace="0" name="iframeMain"></iframe>
      </div> -->
      
      <div id="iframe1Div" style="display:none; position:absolute; top:0px; left:0px; width:100%; height:100%;">
      ...
      <div id="iframe2Div" style="display:block; position:absolute; top:0px; left:0px; width:100%; height:100%;">
