...
client = new Paho.MQTT.Client("113.198.84.66",Number(9001), clientId+"main"); // ip/port/clientId
...
function onConnect() {  // 페이지 로드 되는순간 연결 되는순간 sub시작
   console.log("onConnect-main");
...
function onConnectionLost(responseObject) {
   if (responseObject.errorCode != 0)
      console.log("onConnectionLost-main: "+ responseObject.errorMessage);
							...
							<div class="selectBox">
								<div class="col-md-4">
									<div class="form-group">
										<select class="form-control selectFloor" id="selectFloorInGMT" 
											style="width: 100%;"
											ng-options="t.id as t.name for t in tags" ng-model="t_id"
											onclick="setFloor();">
											<option class="optionFloor" id="allFloor">All Floor</option>
										</select>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<select class="form-control selectClass" id="selectGroupInGMT"
											style="width: 100%;"
											ng-options="t.id as t.name for t in tags" ng-model="t_id"
											disabled="disabled" onclick="setGroup();">
											<option class="optionClass" optionClass="all" >All Class</option>
										</select>
									</div>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
									<div class="has-feedback">
										<input class="form-control" id="groupManagementProcessSearch"
								...
								<div class="box box-primary">
											...
											<table class="table table-striped table-condensed"
												...
												<thead>
													<tr>
														...
														<th style="background-color: #eeeeee; text-align: center;">프로세스</th>
														<th style="background-color: #eeeeee; text-align: center;">시간</th>
														<th style="background-color: #eeeeee; text-align: center;">종료 <input type="checkbox" id="pcManagementItem-all"></th>
													</tr>
												</thead>
												<!-- pc별 관리 테이블의 바디 -->
									...
									<div class="form-group">
												<a href="javascript:void(0)"
													class="btn btn-sm btn-danger btn-flat pull-right" onclick="killPCProcess()">Kill</a>
									</div>
								</div>
								...
								<div class="box box-primary">
									...
									<div class="box-body">
										<div class="selectBox">
											<div class="col-md-4">
												<div class="form-group">
													<select class="form-control selectFloor" id="selectFloorInDCT"
														style="width: 100%;"
														ng-options="t.id as t.name for t in tags" ng-model="t_id"
														onclick="setFloor2();">
														<option selected="selected">All Floor</option>
											...
											<div class="col-md-4">
												<div class="form-group">
													<select class="form-control selectClass" id="selectGroupInDCT"
														style="width: 100%;"
														ng-options="t.id as t.name for t in tags" ng-model="t_id"
											...
											<table class="table table-striped table-condensed"
												...
												<thead>
													<tr>
														...
														<th style="background-color: #eeeeee; text-align: center;">프로세스</th>
														<th style="background-color: #eeeeee; text-align: center;">시간</th>
														<th style="background-color: #eeeeee; text-align: center;">종료 <input type="checkbox" id="detectCheckItem-all"></th>
													</tr>
												</thead>
												<!--  감지확인 테이블의 바디 -->
									...
									<div class="form-group">
										<a href="javascript:void(0)"
											class="btn btn-sm btn-danger btn-flat pull-right" onclick="killProcess()">Kill</a>
									</div>
								</div>
							</div>
								...
								<div class="box box-primary">
									...
									<div class="box-body">
										<div class="selectBox">
											<div class="col-md-4">
												<div class="form-group">
													<select class="form-control selectFloor" id="selectFloorInDLT"
														style="width: 100%;"
														ng-options="t.id as t.name for t in tags" ng-model="t_id"
														onclick="setFloor3();">
														<option selected="selected">All Floor</option>
											...
											<div class="col-md-4">
												<div class="form-group">
													<select class="form-control selectClass" id="selectGroupInDLT"
														style="width: 100%;"
														ng-options="t.id as t.name for t in tags" ng-model="t_id"
